  ...
  <div class="w-12 flex justify-content-center">
    <form @submit.prevent="onFormSubmit" class="w-6 flex-column gap-3 flex">
      ...
      <div class="w-12" v-if="props.showProfile">
        <Select :options="profiles" optionLabel="name" optionValue="code" v-model="user.profile" placeholder="Perfil"
          class="w-12" />
      </div>

      <div class="w-12" v-if="props.showDocument">
        <IftaLabel>
          <InputText class="w-12" v-model="user.document" type="text" :maxlength="user.profile === 'BRANCH' ? 18 : 14"
      ...
      <div class="w-12 flex gap-3">
        <div class="w-8">
          <IftaLabel>
            <InputText class="w-12" v-model="user.address.complement" type="text" />
        ...
        <div class="w-4">
          <IftaLabel>
            <InputText v-model="user.address.zip_code" maxlength="9" type="text" />
            <label>CEP</label>
          </IftaLabel>
        </div>
      </div>
